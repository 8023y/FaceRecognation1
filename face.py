...
def detect_face(img):
    ...
    # 加载OpenCV人脸检测分类器Haar
    face_cascade = cv2.CascadeClassifier(r'D:\App\Anacond\Lib\site-packages\cv2\data\haarcascade_frontalface_default.xml')
...
def draw_text(img, text, x, y):
    cv2.putText(img, text, (x, y), cv2.FONT_HERSHEY_COMPLEX, 2, (255, 0, 0), 2)
...
if __name__ == "__main__":
    ...
    # 加载测试图像
    test_img1 = cv2.imread("test_data/test_1.jpg")
    test_img2 = cv2.imread("test_data/test_2.jpg")
    ...
    cv2.imwrite('cv_final1.jpg', predicted_img1)
    cv2.imwrite('cv_final2.jpg', predicted_img2)
    cv2.waitKey(0)
    cv2.destroyAllWindows()